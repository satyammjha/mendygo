...
export default function Footer() {
    return (
        <footer className="w-full border-t border-white/10 bg-black text-white relative overflow-hidden">
            {/* Footer Content */}
            <div className="relative z-10 mx-auto max-w-7xl px-8 pt-48 pb-20 md:flex md:justify-between md:items-start">
                <div className="mb-10 md:mb-0 md:w-1/2">
                    <div className="flex items-center gap-2 mb-4">
                        <Image src={logo} alt="mendygo" className="h-12 w-12" />
